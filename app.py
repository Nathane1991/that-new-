...
with gr.Blocks(css=css) as demo:
    ...
    with gr.Row():
        ...
        with gr.Column(scale=1):
            gr.Markdown(elem_id="powered-by-prodia", value="AUTOMATIC1111 SoftDistable-Diffusion -satanicsmores Web UI for SDXL V1.0.<br>Powered by [Prodia](https://prodia.com).")
    ...
    with gr.Tab("txt2img"):
        ...
        with gr.Row():
            ...
            with gr.Column(scale=2):
                image_output = gr.Image(value="https://replit.com/cdn-cgi/image/width=1920,quality=80,format=auto/https://storage.googleapis.com/replit/images/1703080822141_d583f0322e00197ebeb73d5a4e7e8943.png")
